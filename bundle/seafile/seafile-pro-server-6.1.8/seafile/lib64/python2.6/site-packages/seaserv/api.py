...
class SeafileAPI(object):
    ...
    # multi-tenancy repo
    def create_org_repo(self, name, desc, username, passwd, org_id):
        return seafserv_threaded_rpc.create_org_repo(name, desc, username, passwd, org_id)

    def create_org_enc_repo(self, repo_id, name, desc, username, magic,
                            random_key, enc_version, org_id):
        return seafserv_threaded_rpc.create_org_enc_repo(
            repo_id, name, desc, username, magic, random_key, enc_version,
            org_id)
