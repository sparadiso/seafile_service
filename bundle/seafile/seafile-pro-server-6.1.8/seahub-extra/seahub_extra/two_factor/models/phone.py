...
from seahub_extra.two_factor.gateways import make_call, send_sms
from seahub_extra.two_factor.utils import random_hex
...
class PhoneDevice(Device):
    ...
    def verify_token(self, token):
        ...
        from seahub_extra.two_factor.utils import totp_digits
