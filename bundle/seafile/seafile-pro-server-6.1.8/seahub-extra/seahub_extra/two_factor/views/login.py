...
from seahub_extra.two_factor import user_has_device
from seahub_extra.two_factor.models import StaticDevice, TOTPDevice, PhoneDevice

from seahub_extra.two_factor.forms import TOTPTokenAuthForm, BackupTokenAuthForm, AuthenticationTokenForm
...
class TwoFactorVerifyView(SessionWizardView):
    ...
    storage_name = 'seahub_extra.two_factor.views.utils.ExtraSessionStorage'
